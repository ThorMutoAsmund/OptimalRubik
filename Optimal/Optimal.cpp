...

{
	...
	if (sscanf_s(string, "%2s %2s %2s %2s %2s %2s %2s %2s %2s %2s %2s %2s %3s %3s %3s %3s %3s %3s %3s %3s",
		...
		edge_str[4], sizeof(edge_str[4]), edge_str[5], sizeof(edge_str[5]), edge_str[6], sizeof(edge_str[6]), edge_str[7], sizeof(edge_str[7]),
		edge_str[8], sizeof(edge_str[8]), edge_str[9], sizeof(edge_str[9]), edge_str[10], sizeof(edge_str[10]), edge_str[11], sizeof(edge_str[11]),
